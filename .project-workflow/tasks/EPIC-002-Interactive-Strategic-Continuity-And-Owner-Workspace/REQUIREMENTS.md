...
Make Strategic Advisor useful as an ongoing, reality-constrained collaborator: it should activate selectively for material strategic work, widen a bounded question when a higher decision altitude could change the answer, actively explore alternatives with the user, reconverge through an evidence-only reality reset, and apply bounded business/venture or marketing/growth lenses when those are the actual decision.
...
- A founder or operator can ask a bounded business or marketing decision that needs commercial, customer, channel, or growth-specific evidence rather than being forced into a generic project lens.
...
- R17. Bounded business/venture decisions can use an explicit lens for customer problem, willingness to pay, unit economics, operating capability, strategic position, and staged commitment without laundering enthusiasm or technical completion into commercial validation.
- R18. Bounded marketing/growth decisions can use an explicit lens for audience, positioning, message, channel, conversion path, incrementality, economics, and experimentation without treating reach, clicks, attribution, or activity as durable demand.
...
- AC14: Business/venture cases distinguish a product or plan from evidence of demand, willingness to pay, viable economics, capability, and strategic advantage, then choose a proportionate test or commitment.
- AC15: Marketing/growth cases distinguish activity and attributed metrics from incremental customer behaviour and economics, then select a bounded audience-message-channel experiment with explicit success, stop, and review conditions.
...
- AC14-AC15: Review a small synthetic set spanning commercial validation, venture commitment, positioning, channel choice, misleading vanity metrics, and direct-assistance controls. Use the current repository checks for structure and record qualitative findings without promoting capability claims.
