...
- Retained proof for this child: deterministic source validation, focused
  assertions, independent QA, parent audit and explicit blockers. Exact-runtime
  behavioural verdicts and sanitised raw outputs remain assigned to TASK-034.
