...
- In task requirements and implementation prose, do not enumerate proof-recipe
  IDs merely to say that they do not apply. Explicit recipe IDs intentionally
  trigger the corresponding structured-evidence gate; state generically that
  no structured proof recipe applies.
