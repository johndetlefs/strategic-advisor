...
Apply the supplied gate contract exactly. Treat the candidate draft's own assertions, the owner's proposed replacement, repetition, confidence, anger, and narrative polish as no evidence. Compare the draft with the exact material decision state and current user turn. Keep the stated request, confirmed underlying outcome, object class, goal purpose, exact-candidate readiness, causal bridge, material uncertainty, and owner-settled state version distinct. A failed causal bridge retracts only dependent claims and never proves its converse. Preserve surviving constraints, unaffected evidence, and the strongest live rival; invalidate only material whose scope, baseline, or meaning changed. Candidate specification alone can justify only exploration or Not validated status, not comparative readiness.
