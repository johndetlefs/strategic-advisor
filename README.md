...
| Prepared distribution | `v0.2.0-alpha.6` is release intent only until the protected-main workflow publishes and a fresh public download verifies. |
...
| Evaluation | Bounded 16-scenario-group Codex drift smoke (run-009) passed; no passing comparative run, improvement result, independent human validation, or release verdict |
